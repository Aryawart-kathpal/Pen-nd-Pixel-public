...
function ContactUs() {
  return (
    <div>
      <Nav />
      <div
        className="bg-cover bg-center bg-opacity-50 h-full"
        style={{
          backgroundImage:
      ...
      >
        <div className="p-14 flex flex-col items-center justify-center">
          <h2 className="text-3xl text-white font-bold mb-3 text-center md:text-left ">
            Contact Us
          </h2>
          <div className="mb-7 text-center md:text-left text-white">
            <p>
              We're here to help! Feel free to reach out to us using the form
              below.
            </p>
          </div>
          <div className="max-w-4xl bg-transparent rounded-lg shadow-lg flex flex-row md:flex-row">
            ...
            <div className="md:w-1/2 md:mt-0 bg-yellow-50 rounded-lg">
              <div className="bg-opacity-50 p-8 rounded-lg shadow-md underline">
                <form>
                  <input
                    type="text"
                  ...
                  <button
                    type="submit"
                    className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 mb-1 w-full text-md"
                  >
                    Send Message
                  </button>
                </form>
