...
const AboutUs = () => {
	return (
		<>
			<Nav />
			<section className="min-[540px]:h-[90svh] p-5 poppins-semibold flex flex-col min-[540px]:overflow-hidden overflow-auto justify-between">
				<h1 className="font-semibold text-5xl">Meet Our Team</h1>
				<p className="py-3 sm:w-[60%]">
					Our team is a with dynamic group of undergraduates. With a compact but
					highly skilled workforce of four friends, we collabrate closely to
					drive innovation and deliver quality solutions.{" "}
				</p>
